...
<a href="orders.php" >Ordenes</a></li><li><a href="orders-new.php">Nueva Orden</a></li></ul><hr>
<div class="col-md-12">
<form action="create-invoice.php" method="post" class="form-inline">
<h4>Crear factura</h4><span class="col-md-4 no-gutter"><input class="form-control"type="text" name="id" placeholder="Order ID" required>&nbsp;
</span><span class="col-md-4 no-gutter"><button class="btn btn-default">Crear factura</button></span></form></div>
<?php 
if(isset($_REQUEST['id'])) {
...
<button class="btn btn-default" id="print-Button"><i class="glyphicon glyphicon-print"></i> imprimir</button>
<br><br>
        ...
        <table cellspacing="0" cellpadding="0" border="0" style="width:720px; padding:0px; padding-left:0px;margin:0px;text-align:left;vertical-align:top;">
         ...
         <table cellspacing="0" cellpadding="0" border="0" style="margin:0px; padding:0px;vertical-align:top;">
          <tbody><tr>
           ...
           <br><p style="vertical-align:top;margin-top:0px;margin-bottom:0px;text-align:right;letter-spacing:5px;font-size:28px;color:#808080;font-weight:bold;font-family:arial;">FACTURA</p>
<br>
        	</td></tr>
...
<br>
         ...
         <tr><td></td></tr>
           ...
           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineItem">Producto </th>

           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineDescription">Opción </th>

           <th style="border-color:#ccc" class="invoiceDataHeadlineEmpty">&nbsp;</th>
           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineUnitPrice">Precio&nbsp;Unitario </th>

           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineQuantity">&nbsp;&nbsp;&nbsp;Cantidad </th>

           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineAmount">&nbsp;&nbsp;&nbsp;Monto </th>
...
?>
   ...
   <tr>
           ...
           <tr><td style="background-color:#eaedee; font-family:verdana; font-size:13px; color:#3c3c3c; font-weight:bold;border-bottom:1px solid #ccc;border-top:1px solid #ccc;padding-top:7px;padding-bottom:7px;padding-left:35px;padding-right:0px;margin-right:0px;" colspan="3">Monto&nbsp;A&nbsp;Pagar&nbsp;<span style="font-family:verdana;&nbsp;font-size:12px;&nbsp;color:#3c3c3c;&nbsp;font-weight:normal;"></span style="font-family:verdana;&nbsp;font-size:12px;&nbsp;color:#3c3c3c;&nbsp;font-weight:normal;"></td>
...
<?php  }else{
echo "<h2 align='center'>ID invalida</h2>";
}}?>
<?php
