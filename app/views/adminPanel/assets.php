...
<script src="<?=PUBLIC_PATH?>js/datatables.js" type="text/javascript"></script>
<link rel="stylesheet" href="<?=PUBLIC_PATH?>css/bootstrap.css">
<link rel="stylesheet" href="<?=PUBLIC_PATH?>css/sidebar.css">
<link rel="stylesheet" href="<?=PUBLIC_PATH?>css/bootstrap-datetimepicker.css">
<link rel="stylesheet" href="<?=PUBLIC_PATH?>css/datatables.css">
<link rel="stylesheet" href="<?=PUBLIC_PATH?>css/estilos_tablas.css">
